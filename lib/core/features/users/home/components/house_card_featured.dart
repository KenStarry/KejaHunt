...
class _HouseCardFeaturedState extends State<HouseCardFeatured> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        context.pushNamed('unit-detail', extra: widget.houseUnitModel);
      },
      child: Container(
        width: 300,
              ...
              child: Container(
                ...
                child: BlocBuilder<UnitsBloc, UnitsState>(
                  builder: (context, unitsState) {
                    return unitsState is UnitsLoading ||
                            (unitsState is UnitsSuccess &&
                                widget.houseUnitModel.images.isEmpty)
                        ? SizedBox.shrink()
                        : ClipRRect(
                            borderRadius: BorderRadius.circular(32),
