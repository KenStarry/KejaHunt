...
final List<UnitFeatureModel> allFeatures = [
  // Inside the Unit
  UnitFeatureModel(featureName: 'Built-in wardrobes', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  UnitFeatureModel(featureName: 'Ensuite bathroom', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  UnitFeatureModel(featureName: 'Bathtub', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  UnitFeatureModel(featureName: 'Hot shower', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  UnitFeatureModel(featureName: 'Kitchenette', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  UnitFeatureModel(featureName: 'Full kitchen', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  UnitFeatureModel(featureName: 'Pantry', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  UnitFeatureModel(featureName: 'Tiled floors', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  ...
  UnitFeatureModel(featureName: 'Ceiling fans', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  UnitFeatureModel(featureName: 'Air conditioning', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  UnitFeatureModel(featureName: 'Balcony/patio', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  UnitFeatureModel(featureName: 'Laundry area', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
  UnitFeatureModel(featureName: 'Internet connection', featureGroup: UnitFeatureGroupsEnum.insideUnit.name, featureLevel: UnitFeatureLevelEnum.unit.name),
